...
public record DadosListagemCondominio(Long id, String nome, String cnpj, String bairro, String cep, String complemento, String numero, String uf, String cidade, int quantidade_torres, Boolean ativo  ) {
